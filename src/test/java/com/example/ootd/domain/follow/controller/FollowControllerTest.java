...
class FollowControllerTest {
    ...
    class GetFollowings {
        ...
        void getFollowings_Success() throws Exception {
            // given
            given(followService.getFollowingList(any(FollowListCondition.class), eq(followerId))).willReturn(followListResponse);
    ...
    class GetFollowers {
        ...
        void getFollowers_Success() throws Exception {
            // given
            given(followService.getFollowerList(any(FollowListCondition.class), eq(followeeId))).willReturn(followListResponse);
